...
class ShopPaymentSucess extends GetView<ShopDetailController> {
  const ShopPaymentSucess({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _infoRow("name_label".tr, controller.shop.name),
                    _infoRow("Wash date", controller.selectedDateApi),
                  ],
                ),
              ),
              const SizedBox(height: 22),
